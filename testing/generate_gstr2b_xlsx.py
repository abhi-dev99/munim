...
meta = [
    ...
    ("Return Period",    "Sept 2026  (05/2026)"),
...
# ITC Summary table
row = len(meta) + 3
ws1[f"A{row}"] = "ITC AVAILABILITY SUMMARY — Sept 2026"
...
notes = [
    ("⚠️  IMPORTANT NOTES", ""),
    ("Royal Optica Frames has NOT filed GSTR-1 for Sept 2026.", "ITC of ₹3,840 is AT RISK — contact supplier urgently"),
...
ws2["A1"] = "B2B Inward Supplies — GSTR-2B Sept 2026"
...
footnotes = [
    ...
    "NOTE: Royal Optica Frames (GSTIN 24AABCR8765H1Z4) has NOT filed GSTR-1 for Sept 2026. ITC of ₹3,840 is AT RISK.",
]
for fn in footnotes:
...
ws3["A1"] = "Munim.ai — ITC Analysis & Action Items  |  Sept 2026  |  Suryakant Optics"
...
analysis_data = [
    ...
    ("ROF/2526/MAY/0156","Royal Optica Frames",            35840.00,  "🔴 AT RISK",          3840.00,  "URGENT: Supplier has NOT filed GSTR-1 for Sept 2026. Call supplier immediately.", RED_BG),
