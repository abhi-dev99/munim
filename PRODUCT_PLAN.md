...
1. Use **Gemini TTS** or AWS TTS to generate Hindi audio
...
Munim: [Sends summary table as image or PDF]
       "Sept 2026 — 23 invoices processed
...
- **For project:** PWA wins on speed and reach
...
For the project presentation, this serves as a live demo panel:
...
### Phase 2 — Post-project (Production MVP)
| # | Item |
|---|------|
